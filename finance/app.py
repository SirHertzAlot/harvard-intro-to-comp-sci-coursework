...
def buy():
    ...
    if request.method == "POST":
        ...
        if funds > totalPrice:
            ...
            db.execute("INSERT INTO transactions (username, symbol, price, UserId) VALUES(?,?,?) FROM users WHERE id = ?", request.form.get("buy"), totalPrice, session["user_id"], session["user_id"])
